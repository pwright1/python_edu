...
class Act2015txt:
    ...
    def process_row(self, conn, fname, line, line_count, actfile_id, ts):
        #print(f"Act2015txt process row {fname} {line_count}")
        ...
        writ_subj      = line[790:792].strip()  # vals 01-36  2015-09 <= tests <  2016-09
        writ_dom1      = line[795:797].strip() 
        writ_dom2      = line[797:799].strip() 
        writ_dom3      = line[799:801].strip() 
        writ_dom4      = line[801:803].strip() 
