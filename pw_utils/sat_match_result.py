...
class SatMatchResult:
    ...
    def __init__(self, sa, susp, mr):
        ...
        #print(f"SatMatchResult bsusp.phone: {bsusp.id1} {bsusp.phone}")
    ...
    def setVals(self, ahid, trec, emplid, ldate, ap_last, susp_last, ap_first, ap_pref, susp_first, ap_mid, smi, ax, sx, ap_dob, susp_dob, ap_ma1, ap_ha1, ap_sa1, susp_addr, ap_mcity, ap_hcity, ap_scity, susp_city, ap_mstate, ap_hstate, ap_sstate, susp_state, ap_mpostal, ap_hpostal, susp_postal, ap_mco, ap_hco, ap_sco, susp_co, ap_ceeb, susp_ceeb, ap_sname, susp_sname, hphone, cphone, mophone, faphone, susp_phone, email, moemail, faemail, susp_email, rat, ape, adr, dob, pho, ceeb, pos, fn, em, npl, ano, ln):
        ...
        self.ap_sname = ap_sname
        self.susp_sname = susp_sname
        ...
        #print(f"the susp_phone is {self.susp_phone}")
        
    def toArr(self):
        arr = [self.ahid, self.trec, self.emplid, self.ldate, self.ap_last, self.susp_last, self.ap_first, self.ap_pref, self.susp_first, self.ap_mid, self.smi, self.ax, self.sx, self.ap_dob, self.susp_dob, self.ap_ma1, self.ap_ha1, self.ap_sa1, self.susp_addr, self.ap_mcity, self.ap_hcity, self.ap_scity, self.susp_city, self.ap_mstate, self.ap_hstate, self.ap_sstate, self.susp_state, self.ap_mpostal, self.ap_hpostal, self.susp_postal, self.ap_mco, self.ap_hco, self.ap_sco, self.susp_co, self.ap_ceeb, self.susp_ceeb, self.ap_sname, self.susp_sname, self.hphone, self.cphone, self.mophone, self.faphone, self.susp_phone, self.email, self.moemail, self.faemail, self.susp_email, self.rat, self.ape, self.adr, self.dob, self.pho, self.ceeb, self.pos, self.fn, self.em, self.npl, self.ano, self.ln]
        return arr
